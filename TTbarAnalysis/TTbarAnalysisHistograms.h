...
void TTbarAnalysis::define_histograms() {
  ...
  hist_etmiss      = new TH1F("hist_etmiss", "Missing Transverse Momentum;E_{T}^{miss} [GeV];Events / bin", 40, 0, 200);
  hist_mtw         = new TH1F("hist_mtw", "Transverse Mass; M^{W}_{T} [GeV];Events / bin", 20, 0, 300);
  hist_syst_etmiss = new TH1F(
  ...
  hist_syst_leadjet_pt = new TH1F("hist_syst_leadjet_pt",
                                  "Leading Jet Transverse Momentum;p_{T}^{jet} [GeV] (after p_{T}^{jet} syst. uncert.);Events / bin", 20, 0, 450);
  ...
  hist_syst_leadleptpt = new TH1F(
      "hist_syst_leadleptpt", "Leading Lepton Transverse Momentum;p_{T}^{leadlep} [GeV] (after p_{T}^{lep} syst. uncert.);Events / bin", 20, 0, 200);
