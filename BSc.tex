...
\begin{abstract}
  ...
  fractions from Angular asymmetries is $F_0=0.635 \pm 0.015$,
  $F_L=0.339 \pm 0.009$ and $F_R=0.026 \pm 0.009$, with only statistical
  uncertainties considered, deviating slightly from the Standard Model.
...
asymmetries are $F_0=0.635 \pm 0.015$, $F_L=0.339 \pm 0.009$ and
