...
the remaining events. Here  	

Applying these parameters to the simulated data, correction factors $e_1$ and $e_3$ were obtained by comparing the simulated data to the Standard
Model expectation, then solving the system of equations obtained from \eqref{eq:asymmetries}. 

\begin{align}
	e_1 = \frac{N_2(1+A_-)}{N_1(A_+-A_-)} = 1.515\cdot 10^{-2} \pm 0.065\cdot 10^  \quad e_3 =  -\frac{N_2(A_+-1)}{N_3(A_+-A_-)} = 0.057 \pm 
\end{align}
