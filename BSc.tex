...
\begin{abstract}
  ...
  uncertainties considered, and angular asymmetries of $A_+ = 0.550 \pm 0.006$
...
\begin{figure}[H]
   ...
   \begin{tikzpicture}
     ...
     %\draw[-latex, line width=3,teal] (-6.4,0.7) -- (-5.3,0.7);
     ...
     %\draw[-latex, line width=2,red] (-1.8,0) -- (-1,0);
     %\draw[-latex, line width=3,teal] (-1,0.7) -- (-2.1,0.7);
     ...
     %\draw[-latex, line width=3,teal] (2.6,0.7) -- (3.7,0.7);
