...
Calorimeters measure the energy of particles by absorbing them. There are Electromagnetic Calorimeters (ECal) and Hadronic Calorimeters (HCal). ECal measures charged particles and photons. 
%Maybe Expand

The hadronic calorimeters consist of scintillator plates that radiates light when exposed to a charged particle. When a hadron passes through a scintillator plate it produces a shower of particles which then makes the scintillator radiate light. The intensity of the radiated light can then be analysed to measure the energy of the hadron.
