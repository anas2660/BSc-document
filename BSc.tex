...
Top quark production at LHC occurs via strong interactions, where they are produced in top, anti-top pairs, then, with almost 100\% branching fraction, they decay by weak interactions into $W$ bosons and bottom quarks. The W bosons decay into either a charged lepton $l$ and neutrino $\nu_l$, or quark into a quark anti-quark pair.

The fraction of; longitudinally $F_0$, left $F_L$ or right $F_R$ polarized $W-$bosons which are produced from top quark decay, we refer to as helicity fractions.
