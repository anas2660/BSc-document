...
\begin{abstract}
  ...
  quark decays, derived from $t\bar t$ events with missing transverse momentum,
  single lepton and at least four jets. The ATLAS Open Data, used in this
  thesis, was taken from $pp$ collisions at a center-of-mass energy of $13$ TeV,
  which corresponds to a integrated luminosity of $1.04$ fb$^{-1}$. Angular
  asymmetries were used as the main method in measuring the polarization of the
  $W$ bosons, with helicity fractions of ?????.
...
\begin{figure}[H]
	...
	\caption{The Feyingle leptonic decay, we see from the figure that there are 4
    quark jets as the end product.}\label{fig:feynmandiagram}%placeholder
\end{figure}
...
directions, at angles given by the polar angle $\theta$, and the azimuthal angle $\phi$.
...
of the jet, with respect to the $x$-axis in the $xy$-plane, as seen in Fig..

\begin{figure}[ht]
  \centering
  \includegraphics{figures/momentum.jpg}\label{fig:momentum}
  \caption{The fgure shows the momentum traveling parallel to the beam axis, and
  the transverse momentum, each with their respective angles.}%placeholder
\end{figure}
...
smaller synchrotron accelerators, as seen in Fig., Proton Syncrotron
Booster (PSB), Proton Syncrotron (PS) and Super Protron Synhrotron
...
\begin{figure}[H]
	...
	\caption{A computer generated image of the ATLAS detector \cite{detector}}
	\label{detector}
\end{figure}
