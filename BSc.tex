...
ionized, which frees electrons that move to the gold wire. The negative charge %befrier det de elektroner som bevæger sig hen til guld ledningen, eller befrier den elektronerne, så de kan bevæge sig hen til guld ledningen?
...
reach the gold wire, the position of the muon can then be determined. The Muon %eks. på ændring: it is possible to determine the position of the muon
...
\section{Methodology}
%Evt nyt afsnit, måske overlap med noget data analysis? 
